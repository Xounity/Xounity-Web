...
const Navbar = () => {
  ...
  return (
      ...
      />
        ...
        <div className='hidden md:flex justify-between items-center gap-8'>
            <ul className='flex justify-between items-center gap-8'>
                ...
                <li className='text-md hover:text-white ease-in-out duration-500'><a href='/events'>Event</a></li>
    ...
    {mob && (
        <div className='w-full h-full text-white fixed top-0 left-0 bg-transparent backdrop-blur-sm flex flex-col justify-center items-center gap-5 z-40 md:hidden'>
