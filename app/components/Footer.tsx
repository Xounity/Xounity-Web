        ...
        <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          ...
          >
            <Image
              src={lightlogo}
              alt="logo"
              className="logo-light w-36 object-cover cursor-pointer transition-opacity duration-300"
            />
            <Image
              src={darklogo}
              alt="logo"
              className="logo-dark w-36 object-cover cursor-pointer transition-opacity duration-300"
            />
          </Link>
