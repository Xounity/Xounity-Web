        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          >
            ...
            <p className="mb-8 leading-relaxed delay-100 text-gray-400">
              ...
              unite under one vision. Together, we&apos;re creating a zone for
              an inclusive future. #Xounity
            </p>
            <div className="flex justify-center delay-100">
              ...
              <div className="social-icons flex items-center justify-center gap-4 flex-wrap">
                ...
                <Link
                  href="https://discord.com/invite/V9mJaQUAu4"
                  target="_blank"
                  rel="noopener noreferrer"
                  title="Discord"
                >
                ...
                <Link
                  href="https://www.youtube.com/@xounity1"
                  target="_blank"
                  rel="noopener noreferrer"
                  title="YouTube"
                >
