      ...
      >
        <div className="image-card flex flex-col items-center text-center">
          ...
          <div className="w-full image-content">
            ...
            <h3 className="text-xounity-blue mb-3 font-medium">{title}</h3>
            <p className="mb-4 text-xounity-blue font-medium">{description}</p>
...
export const TeamCardMobile: React.FC<TeamCardProps> = ({
  name,
  image,
  description,
  title,
    ...
    >
      <div className="h-full flex flex-col items-center text-center">
        ...
        <div className="w-full">
          ...
          <span className="inline-flex">
            {/* linkedin hollow logo */}
            <Link href={linkedinSrc} target="_blank" className="text-gray-500">
              <svg
                fill="none"
                stroke="currentColor"
                strokeLinecap="round"
