...
import mirza from "images/mirza.jpg"
import muhaddis from "images/Muhaddis-mob.jpg"
import ahmed from "images/Ahmed-mob.jpeg"
import junaid from "images/junaid.webp"
...
const About = () => {
  ...
  {/* About start */}
  {/* About Desktop */}
  <section id="about" className="text-gray-400 body-font hidden md:flex">
        ...
        >
          <div className="image-card flex flex-col items-center text-center">
            ...
            <div className="w-full image-content">
              ...
              <h3 className="text-xounity-blue mb-3 font-medium">Tech Team</h3>
              <p className="mb-4 text-xounity-blue font-medium">
  ...
  {/* About Mobile */}
  <section id="mob-about" className="text-gray-500 body-font md:hidden">
    <div className="container px-5 py-24 mx-auto">
      <div className="flex flex-col text-center w-full mb-20">
